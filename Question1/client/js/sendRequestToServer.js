...
async function sendRequest() {
  ...
  const temperatureSlider = document.getElementById("tempInput");
  const maxTokensSlider = document.getElementById("tokensInput");
  ...
  promptData.append("temperature", temperatureSlider.value);
  promptData.append("max_tokens", maxTokensSlider.value);
